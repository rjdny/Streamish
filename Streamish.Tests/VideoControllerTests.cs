...
namespace Streamish.Tests
{
    public class VideoControllerTests
    {
        ...
        [Fact]
        public void Search_Returns_Correct_Videos()
        {
            // Arrange
            List<Video> randomVids = CreateTestVideos(10);
            randomVids[0].Title = "This Is The Correct One!";

            var repo = new InMemoryVideoRepository(randomVids);

            // Act
            var ret = repo.Search("This Is The Correct One!", false);

            // Assert
            Assert.True(ret.Count == 1);
            Assert.Equal("This Is The Correct One!", ret.FirstOrDefault().Title);
        }
        ...
        public static UserProfile CreateTestUserProfile(int id)
        {
